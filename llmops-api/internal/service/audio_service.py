...
from internal.service import BaseService, AppService
...
class AudioService(BaseService):
    ...
    def audio_to_text(self, audio: FileStorage) -> str:
        """将传递的语音转成文本"""
        # 1. 提取音频文件，并将音频文件转成FileContent类型
    ...
    def message_to_audio(self, message_id: UUID, account: Account):
        """将消息转换车恶搞流式输出语音"""
        ...
        if conversation is None or conversation.is_delete or conversation.created_by != account.id:

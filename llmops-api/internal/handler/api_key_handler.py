...
from internal.schema import CreateApiKeyReq, UpdateApiKeyReq, UpdateApiKeyIsActiveReq, GetApiKeysWithPageResp
...
class ApiKeyHandler:
    ...
    def update_api_key_is_active(self, api_key_id: UUID):
        ...
        return success_message("更新API密钥的激活状态成功")

...
from internal.schema.document_schema import GetDocumentResp, UpdateDocumentNameReq, GetDocumentsWithPageReq, \
    GetDocumentsWithPageResp, UpdateDocumentEnabledReq
...
class DocumentHandler:
    ...
    def get_documents_with_page(self, dataset_id: UUID):
        ...
        documents, paginator = self.document_service.get_documents_with_page(dataset_id, current_user, req)
    ...
    def get_document_status(self, dataset_id: UUID, batch: str):
        ...
        documents_status = self.document_service.get_document_status(dataset_id, batch, account=current_user)

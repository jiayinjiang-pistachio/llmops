...
Revision ID: f1be50c2de44
Revises: e6707603df9a
Create Date: 2025-12-30 16:03:45.149224
...
revision = 'f1be50c2de44'
down_revision = 'e6707603df9a'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('mim_type', sa.String(length=255), server_default=sa.text("''::character varying"), nullable=False),

...
# -*- coding: utf-8 -*-
"""
@Time           : 2025/12/17 17:46
@Author         : jiayinkong@163.com
@File           : 1-不支持函数调用的模型解决技巧.py
@Description    : 
"""
import json
import os
...
def invoke_tool(
    ...
    return tool.invoke(tool_call_request.get("arguments"), config=config)
...
# print(chain.invoke({"query": "广州今天的天气怎么样？"}))
# 输出：{'name': 'gaode_weather_tool', 'arguments': {'city': '广州'}}

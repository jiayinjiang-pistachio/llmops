...
def paralle1(state: MessagesState, config: dict) -> Any:
    print("并行1: ", state)
    return {"messages": [HumanMessage(content="这是并行1函数")]}


def paralle2(state: MessagesState, config: dict) -> Any:
    print("并行2: ", state)
...
graph_builder.add_edge("chatbot", "paralle1")
graph_builder.add_edge("chatbot", "paralle2")
graph_builder.add_edge("paralle2", "chat_end")
